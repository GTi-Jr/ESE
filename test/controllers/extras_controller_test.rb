...
class ExtrasControllerTest < ActionController::TestCase
  ...
  test "should create extra" do
    assert_difference('Extra.count') do
      post :create, extra: { description: @extra.description, limit: @extra.limit, price: @extra.price, title: @extra.title }
    end
  ...
  test "should update extra" do
    patch :update, id: @extra, extra: { description: @extra.description, limit: @extra.limit, price: @extra.price, title: @extra.title }
    assert_redirected_to extra_path(assigns(:extra))
  end
