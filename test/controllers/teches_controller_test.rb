...
class TechesControllerTest < ActionController::TestCase
  ...
  test "should create tech" do
    assert_difference('Tech.count') do
      post :create, tech: { day: @tech.day, description: @tech.description, limit: @tech.limit, price: @tech.price, time: @tech.time, title: @tech.title }
    end
  ...
  test "should update tech" do
    patch :update, id: @tech, tech: { day: @tech.day, description: @tech.description, limit: @tech.limit, price: @tech.price, time: @tech.time, title: @tech.title }
    assert_redirected_to tech_path(assigns(:tech))
  end
